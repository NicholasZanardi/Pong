...
public class PlayerControl : MonoBehaviour
{
    ...
    //Tombol untuk power up size
    public KeyCode powerButton = KeyCode.D;

    //Tombol untuk stop power size
    public KeyCode stopButton = KeyCode.A;
    ...
    void Update()
    {
        ...
        //simpan local scale awal obj di kedua temp , temp 1 untuk di ubah , temp 2 untuk nyimpan original
        temp = transform.localScale;

        //Jika ada yang menekan power button
        if (Input.GetKey(powerButton))
        {
            //simpan local scale awal obj di kedua temp , temp 1 untuk di ubah , temp 2 untuk nyimpan original
            temp = transform.localScale;
            //nambah size player sementara
        ...
        //Jika ada yang menekan stop button 
